        ...
        function createChart() {
            ...
            $container.highcharts({
                ...
                series: [
                    {
                        name: "Sd2plusData",
                        data:  $scope.dataservice.getChartLineSd2PlusData(),
                        color: 'rgb(216, 234, 240)'
                    },
                    {
                        name: "Sd1plusData",
                        data: $scope.dataservice.getChartLineSd1PlusData(),
                        color: 'rgb(89, 161, 186)'
                    },
                    {
                        name: "Sd1MinusData",
                        data: $scope.dataservice.getChartLineSd1MinusData(),
                        color: "rgb(180, 204, 212)"
                    },
                    {
                        name: 'Sd2MinusValue',
                        data: $scope.dataservice.getChartLineSd2MinusData(),
